  ...
  interface CustomTypeOptions {
    ...
    resources: {
      translation: {
        ...
        loggingIn: string;
        loginError: string;
        stepSignatureTitle: string;
        uploadSignatureLabel: string;
