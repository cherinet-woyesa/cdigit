...
import type { QRCodePayload, QRValidationResult, BranchContext } from '@types';
import { QRCodeError } from '@types';
import { ERROR_MESSAGES, QR_CODE_EXPIRATION } from '@constants/multiChannelAccess';
import { qrCodeParser } from '@services/multiChannel/qrCodeParser';
import { qrCodeGenerator } from '@services/multiChannel/qrCodeGenerator';
import { getBranchById } from '@services/branch/branchService';
