...
const eBankingApplicationService = {
  apply: applyEBankingApplication,
  getAll: getEBankingApplications,
  getById: getEBankingApplicationById,
  getByPhone: getEBankingApplicationsByPhone,
  update: updateEBankingApplication,
  delete: deleteEBankingApplication,
  cancelByCustomer: cancelEBankingApplicationByCustomer
};

export default eBankingApplicationService;
