...
export default function DepositConfirmation() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f0ff] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-purple-200">
        {/* Header */}
        <div className="bg-purple-700 p-6 text-center text-white">
          <CheckCircleIcon className="h-16 w-16 mx-auto text-purple-200" />
          <h1 className="text-2xl font-bold mt-4">Deposit Submitted Successfully!</h1>
          <p className="text-purple-100 mt-2">Please proceed to the counter with your token</p>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-purple-50 rounded-lg p-4 border border-purple-100">
            <div className="text-center">
              <p className="text-sm text-purple-600">Your Token Number</p>
              <p className="text-4xl font-bold text-purple-700 my-2">{confirmationData.token}</p>
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full bg-white border border-purple-600 text-purple-700 font-medium py-2 px-4 rounded-lg hover:bg-purple-50 transition"
            >
              Print Confirmation
            </button>
