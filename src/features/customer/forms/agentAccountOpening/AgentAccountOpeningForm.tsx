...
import { agentAccountOpeningService } from '../../../../services/agentAccountOpeningService';
    ...
    <FormLayout title="Agent Account Opening" branchName={branch?.name}>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <input name="tradeLicenseNumber" value={formData.tradeLicenseNumber} onChange={handleChange} placeholder="Trade License Number" className="w-full p-2 border rounded" />
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">License Expire Date</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input name="emailAddress" value={formData.emailAddress} onChange={handleChange} placeholder="Email Address" className="w-full p-2 border rounded" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input name="fatherName" value={formData.fatherName} onChange={handleChange} placeholder="Father's Name" className="w-full p-2 border rounded" />
            <input name="grandfatherName" value={formData.grandfatherName} onChange={handleChange} placeholder="Grandfather's Name" className="w-full p-2 border rounded" />
        ...
        <input name="agentBankAccountNumber" value={formData.agentBankAccountNumber} onChange={handleChange} placeholder="Agent Bank Account Number" className="w-full p-2 border rounded" />
